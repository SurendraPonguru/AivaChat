...
const PageLoader: React.FC = () => {
  return (
    <div className="fixed inset-0 bg-slate-900 bg-opacity-80 backdrop-blur-sm flex flex-col items-center justify-center z-50">
      ...
      <p className="mt-6 text-xl text-slate-200 font-semibold">Loading AivaChat ✨</p>
      <p className="mt-2 text-sm text-slate-400">Please wait while we prepare your experience...</p>
    </div>
  );
};
